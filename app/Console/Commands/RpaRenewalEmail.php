...
class RpaRenewalEmail extends Command
{
     ...
     * @var string
     */
    protected $signature = 'rpa:renewal:email {--debug} {--file=} {--single} {--dryrun}';
    ...
    public function processData($data): bool
    {
        ...
        try {
            ...
            if (strtolower($data['service_state']) == "pa") {
                ...
                if (!strtolower($data['letter_version']) == "1st letter" && !strtolower($data['letter_version']) == "2nd letter") {
            ...
            if (strtolower($data['service_state']) == "pa") {
                $letterTemplate = "emails.rpa_renewal_" . strtolower($data['service_state']) . "_" . (strtolower($data['letter_version']) == "1st letter" ? "1st" : "2nd") . "_" . $commodity;
            } else {
                $letterTemplate = "emails.rpa_renewal_" . strtolower($data['service_state']) . "_" . $commodity;
            }
